...
class ElementHandle(JSHandle):
    ...
    async def hover(
        ...
        *,
        ...
        This method hovers over the element by performing the following step_definitions:
        ...
        When all step_definitions combined have not finished during the specified `timeout`, this method throws a `TimeoutError`.
    ...
    async def click(
        ...
        *,
        ...
        This method clicks the element by performing the following step_definitions:
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the element, unless `force` option is set.
        1. Scroll the element into view if needed.
    ...
    async def dblclick(
        ...
        *,
        ...
        This method double clicks the element by performing the following step_definitions:
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the element, unless `force` option is set.
        1. Scroll the element into view if needed.
    ...
    async def tap(
        ...
        *,
        ...
        This method taps the element by performing the following step_definitions:
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the element, unless `force` option is set.
        1. Scroll the element into view if needed.
    ...
    async def set_checked(
        ...
        *,
        ...
        This method checks or unchecks an element by performing the following step_definitions:
    ...
    async def check(
        ...
        *,
        ...
        This method checks the element by performing the following step_definitions:
...
class Frame(AsyncBase):
    ...
    async def click(
        ...
        *,
        ...
        This method clicks an element matching `selector` by performing the following step_definitions:
    ...
    async def dblclick(
        ...
        *,
        ...
        This method double clicks an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the matched element, unless `force` option is set. If
           the element is detached during the checks, the whole action is retried.
        1. Scroll the element into view if needed.
    ...
    async def tap(
        ...
        *,
        ...
        This method taps an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the matched element, unless `force` option is set. If
           the element is detached during the checks, the whole action is retried.
        1. Scroll the element into view if needed.
    ...
    async def hover(
        ...
        *,
        ...
        This method hovers over an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the matched element, unless `force` option is set. If
           the element is detached during the checks, the whole action is retried.
        1. Scroll the element into view if needed.
    ...
    async def check(
        ...
        *,
        ...
        This method checks an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
    ...
    async def set_checked(
        ...
        *,
        ...
        This method checks or unchecks an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
...
class Page(AsyncContextManager):
    ...
    async def uncheck(
        ...
        *,
        ...
        This method unchecks an element matching `selector` by performing the following step_definitions:
        1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
        1. Ensure that matched element is a checkbox or a radio input. If not, this method throws. If the element is
           already unchecked, this method returns immediately.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the matched element, unless `force` option is set. If
    ...
    async def pause(self) -> None:
        ...
        User can inspect selectors or perform manual step_definitions while paused. Resume will continue running the original script
...
class Locator(AsyncBase):
    ...
    async def check(
        ...
        **Details**
        ...
        Performs the following step_definitions:
        1. Ensure that element is a checkbox or a radio input. If not, this method throws. If the element is already
           checked, this method returns immediately.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the element, unless `force` option is set.
        1. Scroll the element into view if needed.
    ...
    async def uncheck(
        ...
        **Details**
        ...
        This method unchecks the element by performing the following step_definitions:
        1. Ensure that element is a checkbox or a radio input. If not, this method throws. If the element is already
           unchecked, this method returns immediately.
        1. Wait for [actionability](https://playwright.dev/python/docs/actionability) checks on the element, unless `force` option is set.
        1. Scroll the element into view if needed.
