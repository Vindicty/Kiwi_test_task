...
def track(
    ...
    Args:
        ...
        total: (float, optional): Total number of step_definitions. Default is len(sequence).
...
class ProgressSample(NamedTuple):
    ...
    """Timestamp of sample."""
    completed: float
    """Number of step_definitions completed."""
...
class Task:
    ...
    """Optional[float]: Total number of step_definitions in this task."""

    completed: float
    """float: Number of step_definitions completed"""
    ...
    def remaining(self) -> Optional[float]:
        """Optional[float]: Get the number of step_definitions remaining, if a non-None total was set."""
    ...
    def speed(self) -> Optional[float]:
        """Optional[float]: Get the estimated speed in step_definitions per second."""
        if self.start_time is None:
            return None
        with self._lock:
...
class Progress(JupyterMixin):
    ...
    def reset(
        ...
        **fields: Any,
        ...
        Args:
            ...
            total (float, optional): New total step_definitions in task, or None to use current total. Defaults to None.
            completed (int, optional): Number of step_definitions completed. Defaults to 0.
    ...
    def advance(self, task_id: TaskID, advance: float = 1) -> None:
        """Advance task by a number of step_definitions.

        Args:
            task_id (TaskID): ID of task.
            advance (float): Number of step_definitions to advance. Default is 1.
        """
        current_time = self.get_time()
        with self._lock:
            task = self._tasks[task_id]
    ...
    def add_task(
        ...
        **fields: Any,
        ...
        Args:
            ...
            total (float, optional): Number of total step_definitions in the progress if known.
                Set to None to render a pulsing animation. Defaults to 100.
            completed (int, optional): Number of step_definitions completed so far. Defaults to 0.
            visible (bool, optional): Enable display of the task. Defaults to True.
            **fields (str): Additional data fields required for rendering.
