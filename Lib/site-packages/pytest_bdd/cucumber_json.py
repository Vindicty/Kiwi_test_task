...
class LogBDDCucumberJSON:
    ...
    def pytest_runtest_logreport(self, report: TestReport) -> None:
        ...
        if not scenario["step_definitions"] or report.when != "call":
            # skip if there isn't a result or scenario has no step_definitions
            return
        ...
        self.features[scenario["feature"]["filename"]]["elements"].append(
            {
                ...
                "type": "scenario",
                "step_definitions": [stepmap(step) for step in scenario["step_definitions"]],
            }
        )
