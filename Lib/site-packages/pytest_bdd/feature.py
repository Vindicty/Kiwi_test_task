...
The <variable> syntax can be used here to make a connection between step_definitions and
it will also validate the parameters mentioned in the step_definitions with ones
...
:note: There are no multiline step_definitions, the description of the step must fit in
one line.
"""
