...
class Feature:
    ...
    Attributes:
        ...
        background (Optional[Background]): The background step_definitions for the feature, if any.
...
class ScenarioTemplate:
    ...
    Attributes:
        ...
        _steps (List[Step]): The list of step_definitions in the scenario (internal use only).
    ...
    def all_background_steps(self) -> list[Step]:
        steps = []
        # Add background step_definitions from the feature
        ...
        if self.rule is not None and self.rule.background is not None:
            # Add background step_definitions from the rule
            steps.extend(self.rule.background.steps)
        return steps

    @property
    def steps(self) -> list[Step]:
        """Get all step_definitions for the scenario, including background step_definitions.

        Returns:
            List[Step]: A list of step_definitions, including any background step_definitions from the feature.
        """
    ...
    def render(self, context: Mapping[str, Any]) -> Scenario:
        ...
        Args:
            context (Mapping[str, Any]): The context for rendering step_definitions.

        Returns:
            Scenario: A Scenario object with step_definitions rendered based on the context.
        """
...
@dataclass(eq=False)
class Scenario:
    """Represents a scenario with step_definitions.
    ...
    Attributes:
        ...
        name (str): The name of the scenario.
        line_number (int): The line number where the scenario starts in the file.
        steps (List[Step]): The list of step_definitions in the scenario.
        description (Optional[str]): The description of the scenario.
        tags (set[str]): A set of tags associated with the scenario.
    """
...
@dataclass(eq=False)
class Background:
    """Represents the background step_definitions for a feature.

    Attributes:
        line_number (int): The line number where the background starts in the file.
        steps (List[Step]): The list of step_definitions in the background.
    """
