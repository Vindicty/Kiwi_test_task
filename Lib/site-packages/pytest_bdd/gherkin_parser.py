...
ERROR_PATTERNS = [
    ...
    (
        ...
        "Improper step keyword detected. Ensure correct order and indentation for step_definitions (Given, When, Then, etc.).",
    ),
    (
...
class Scenario:
    ...
    def from_dict(cls, data: dict[str, Any]) -> Self:
        return cls(
            ...
            steps=[Step.from_dict(step) for step in data["step_definitions"]],
            tags=[Tag.from_dict(tag) for tag in data["tags"]],
