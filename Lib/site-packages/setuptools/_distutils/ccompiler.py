...
class CCompiler:
    ...
    instance can be used for all the compile/link step_definitions in building a
    single project.  Thus, attributes common to all of those compile and
    link step_definitions -- include directories, macros to define, libraries to link
